<?php
    ...
    if(isset($_POST['save_product_btn'])){
        ...
        if(!empty($name) && !empty($description) && !empty($primaryImage)){
            ...
            if($p->create(['name'=>$name, 'description'=>$description, 'image'=>$primaryImage]))
    ...
    if(isset($_GET['action']) && ($_GET['action']) == 'edit'){
        if(isset($_GET['product_id']) && (is_numeric($_GET['product_id']))){
            ...
            header("Location: about-edit-product.php");
        }
        else{
...
<body>
        ...
        <div class="create">
            <div class="form">
                <!-- Create Product -->
                <h2>Add new About Content</h2>
                <a href="adminpanel.php">Add new Service Content</a>
